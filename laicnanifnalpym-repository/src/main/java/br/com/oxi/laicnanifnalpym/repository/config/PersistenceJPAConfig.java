package br.com.oxi.laicnanifnalpym.repository.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = { "br.com.oxi.laicnanifnalpym.repository.jpa" })
...
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "br.com.oxi" });
