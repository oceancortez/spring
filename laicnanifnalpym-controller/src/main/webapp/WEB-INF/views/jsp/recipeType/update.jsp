		...
		<div class="container">
			...
			<section>
				...
				<p>
					...
					<sf:form modelAttribute="recipeForm" action="/receita/atualizar" method="post">
						<table border="0">
							<tr>
								<td><label for="receivedStatus">Estatus da Receita:</label></td>
								<td>
								<sf:select path="receivedStatus">
										<sf:option value="" label="--- Selecione ---" />
										<sf:options items="${receivedStatus}"/>
									</sf:select>
								</td>
								<td><sf:errors path="receivedStatus" cssClass="error" /></td>
							</tr>
							<tr>
								<td colspan="2"></br></td>
							</tr>
							...
							<tr align="center">
								...
								<td colspan="2"><input class="btn btn-primary btn-md" type="submit" value="Atualizar" size="20" />								
								
								 <a class="btn btn-default"	href="/receita" role="button">Cancel</a></td>
							</tr>
						</table>
					</sf:form>
			</section>
