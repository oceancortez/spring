package br.com.oxi.laicnanifnalpym.controller.test;
...
import br.com.oxi.laicnanifnalpym.middleware.service.test.LaicnanifnalpymService;
...
public class LaicnanifnalpymController {
	...
	public ModelAndView buildView(){
		...
		List<LaicnanifnalpymEntity> list = laicnanifnalpymService.list();		
