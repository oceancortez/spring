...
public abstract class AbstractGenericServiceRest<T extends BaseEntity<PK>, PK extends Serializable> implements IGenericServiceRest<T, PK> {
	...
	public AbstractGenericServiceRest() {
