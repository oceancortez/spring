...
public class OrderEntity extends BaseBean {
    ...
    public OrderEntity(String customerId, Long employeeId, Date orderDate, Date requiredDate, Date shippedDate, Long shipVia, BigDecimal freight, String shipName, String shipAddress, String shipCity, String shipRegion, String shipPostalCode, String shipCountry) {
